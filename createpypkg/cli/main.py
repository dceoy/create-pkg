...
def _create_python_package_scaffold(
    args, include_package_data=True, create_dockerfile=True
):
    logger = logging.getLogger(__name__)
    ...
    if not repo_dir.is_dir():
        raise FileNotFoundError(f"No such directory: {repo_dir}")
